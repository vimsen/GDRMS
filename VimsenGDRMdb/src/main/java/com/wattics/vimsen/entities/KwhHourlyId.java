...
/**
 * KwhHourlyId generated by hbm2java
 */
public class KwhHourlyId implements java.io.Serializable {
  ...
  public KwhHourlyId(int equipmentId, DateTime date) {
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof KwhHourlyId))
      return false;
    KwhHourlyId castOther = (KwhHourlyId) other;
