...
public class GDRMDataGetterTest {
	...
	private int storeMarketSignalAndPlan() throws DataAccessLayerException {
		...
		MarketSignal marketSignal = DatabaseSetUp.storeMarketSignal(hibernateUtil, startTimeText, dateTimeStart,
				reduction, primaryProsumers, secondaryProsumers);
	...
	@Test
	public void getKwhForecastDateTimeNotMidnightFails() throws NoSuchMethodException, SecurityException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException, DataAccessLayerException {
		// TODO: modify test if it is necessary to store data from EDMS in GDRM
		// database
		// Kwh15mn kwh15mn = new Kwh15mn();
		// kwh15mn.setT0000(0.0);
	...
	public void getMarketSignalTime() throws DataAccessLayerException {
		...
		DateTime expectedDateTime = TimeHelpers.timestampUtcFormatterISO8601.withOffsetParsed()
				.parseDateTime(marketSignalDate);
