...
public class OneToManyMappingTest {
    ...
    public void insertNewElement() throws DataAccessLayerException {
        ...
        Equipment newEquipment = new Equipment(7, siteFound, "cdf", null, "abc",
                null, null, null, null, null, null, null, null, null, null,
                null, null, new HashSet(Arrays.asList("a")), null, null, null);
    ...
    public void updateOrInsertElement() throws DataAccessLayerException {
        ...
        try {
            ...
            Equipment newEq = new Equipment(7, siteFound, "cdf", null, "abc",
                    null, null, null, null, null, null, null, null, null, null,
                    null, null, new HashSet(Arrays.asList("a")), null, null, 
                    null);
